export const zh = {
  ...
  legal_privacy_collect_text:
    "本網站可能蒐集以下類別的個人資料：(1) 結帳資訊：當您透過商店功能下單時，需提供姓名、電子郵件、電話號碼、地址、城市、郵遞區號及國家代碼等帳單資訊，用於建立 WooCommerce 訂單。(2) 瀏覽行為資料：本網站可能透過 Cookie 或類似技術蒐集您的 IP 位址、瀏覽器類型及瀏覽行為，用於改善網站體驗。您得自由選擇是否提供結帳所需之個人資料；如您選擇不提供，將無法完成訂單建立，但不影響您使用網站其他功能（內容瀏覽、3D 模型檢視等）。",
  legal_privacy_purpose_title: "二、蒐集目的與利用方式",
  legal_privacy_purpose_text:
    "本公司蒐集個人資料之特定目的包括：(1) 訂單處理與履約：處理商店訂單、建立付款連結、聯繫配送相關事宜。(2) 客戶服務：回應您的諮詢，提供售後支援。(3) 網站功能運作：提供內容瀏覽、3D 模型檢視、商品展示等服務。(4) 網站分析與改善：了解使用者行為以優化網站設計與效能。個人資料之利用不會超出上述特定目的之必要範圍，利用地區以中華民國境內為主，惟透過第三方服務（詳見第四節）處理時可能涉及境外傳輸。",

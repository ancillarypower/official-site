export const zh = {
  ...
  models_batch_limit: "最多一次上傳 {n} 個檔案，已截取前 {n} 個",
  ...
  models_sort_name_desc: "名稱 Z\u2192A",
  models_sort_size_asc: "大小（小\u2192大）",
  models_sort_size_desc: "大小（大\u2192小）",
  models_sort_ext_asc: "類型 A\u2192Z",
  models_sort_ext_desc: "類型 Z\u2192A",
  models_sort_date_desc: "建立時間（新\u2192舊）",
  models_sort_date_asc: "建立時間（舊\u2192新）",
  models_sort_updated_desc: "修改時間（新\u2192舊）",
  models_sort_updated_asc: "修改時間（舊\u2192新）",
  ...
  checkout_required_fields: "請填寫所有必填欄位",
  ...
  about_highlight_acer: "宏碓龍騰微笑獎國際組參獎，獎勵立足台灣、放眼全球的新創企業",

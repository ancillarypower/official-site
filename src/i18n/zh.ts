export const zh = {
  ...
  models_delete_confirm: "確定要刪除「{name}」嗎？此操作無法復原。",
  ...
  legal_privacy_intro_text:
    "安瑟樂威（Ancillary Power，以下簡稱「本公司」）重視您的個人資料保護。本隱私權政策依據中華民國《個人資料保護法》（個資法）制定，說明本網站如何蒲集、處理及利用您的個人資料。使用本網站即表示您已閱讀並理解本政策內容。",
  legal_privacy_collect_title: "一、我們蒲集哪些資料",
  legal_privacy_collect_text:
    "本網站可能蒲集以下類別的個人資料：(1) 結帳資訊：當您透過商店功能下單時，需提供姓名、電子郵件、電話號碼、地址、城市、郵遞區號及國家代碼等帳單資訊，用於建立 WooCommerce 訂單。(2) 瀏覽行為資料：本網站可能透過 Cookie 或類似技術蒲集您的 IP 位址、瀏覽器類型及瀏覽行為，用於改善網站體驗。您得自由選擇是否提供結帳所需之個人資料；如您選擇不提供，將無法完成訂單建立，但不影響您使用網站其他功能（內容瀏覽、3D 模型檢視等）。",
  legal_privacy_purpose_title: "二、蒲集目的與利用方式",
  legal_privacy_purpose_text:
    "本公司蒲集個人資料之特定目的包括：(1) 訂單處理與履約：處理商店訂單、建立付款連結、聯繫配送相關事宜。(2) 客戶服務：回應您的諮詢，提供售後支援。(3) 網站功能運作：提供內容瀏覽、3D 模型檢視、商品展示等服務。(4) 網站分析與改善：了解使用者行為以優化網站設計與效能。個人資料之利用不會超出上述特定目的之必要範圍，利用地區以中華民國境內為主，惟透過第三方服務（詳見第四節）處理時可能涉及境外傳輸。",
  ...
  legal_privacy_rights_text:
    "依據《個人資料保護法》第三條，您就本公司所持有之個人資料享有以下權利：(1) 查詢或請求閱覽。(2) 請求製給複製本。(3) 請求補充或更正。(4) 請求停止蒲集、處理或利用。(5) 請求刪除。如需行使上述權利，請透過本政策末端所列之聯絡方式與我們聯繫，本公司將於收到請求後依法定期限內回覆處理。",
  legal_privacy_retention_title: "七、資料保存期間",
  legal_privacy_retention_text:
    "本公司將在達成蒲集目的之必要期間內保存您的個人資料。訂單相關資料依稅務法規保存五年；其他個人資料於蒲集目的消失或您請求刪除後，依法予以刪除或停止處理利用。本機儲存資料（IndexedDB、localStorage）由您自行管理，可隨時清除。",
